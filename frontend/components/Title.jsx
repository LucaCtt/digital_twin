...
const Title = () => {
  ...
  return (
    <header className="flex w-full flex-row items-center justify-between rounded-lg bg-green-100 p-8 dark:border-gray-700 dark:bg-green-900">
      <div className="flex flex-row items-center justify-between gap-8 leading-normal">
        <MdLightbulbCircle className="h-16 w-16 rounded-full text-green-700 dark:border-green-300 dark:text-green-300" />
